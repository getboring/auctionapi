...
- **Parameters:**
  | Name | Type | Description |
  |------|------|-------------|
  | data | `RainWorx.FrameWorx.DAL IDataContext` | (Not documented in source) |
  | accounting | `RainWorx.FrameWorx.Services IAccountingService` | (Not documented in source) |
  | common | `RainWorx.FrameWorx.Services ICommonService` | (Not documented in source) |
  | site | `RainWorx.FrameWorx.Services ISiteService` | (Not documented in source) |
  | auctionEvent | `RainWorx.FrameWorx.Services IEventService` | (Not documented in source) |
  | queueManager | `RainWorx.FrameWorx.Queueing IQueueManager` | (Not documented in source) |
  | notifier | `RainWorx.FrameWorx.Services INotifierService` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  | newCategory | `RainWorx.FrameWorx.DTO Category` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | customField | `RainWorx.FrameWorx.DTO CustomField` | (Not documented in source) |
- **Returns:** Int32
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | media | `RainWorx.FrameWorx.DTO.Media Media` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  | input | `RainWorx.FrameWorx.DTO UserInput` | (Not documented in source) |
  | pageIndex | `System Int32` | (Not documented in source) |
  | pageSize | `System Int32` | (Not documented in source) |
  | sortColumn | `System String` | (Not documented in source) |
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | category | `RainWorx.FrameWorx.DTO Category` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  | Name | Type | Description |
  |------|------|-------------|
  | propertyBag | `RainWorx.FrameWorx.DTO PropertyBag` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | userInput | `RainWorx.FrameWorx.DTO UserInput` | (Not documented in source) |
- **Returns:** Banner
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | customCurrency | `RainWorx.FrameWorx.DTO CustomCurrency` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | siteProperty | `RainWorx.FrameWorx.DTO CustomProperty` | (Not documented in source) |
- **Returns:** Int32
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | newState | `RainWorx.FrameWorx.DTO State` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | content | `RainWorx.FrameWorx.DTO Content` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | country | `RainWorx.FrameWorx.DTO Country` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | state | `RainWorx.FrameWorx.DTO State` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  | properties | `System.Collections.Generic Dictionary String , String` | (Not documented in source) |
  | oldListing | `RainWorx.FrameWorx.DTO Listing` | (Not documented in source) |
  | newListing | `RainWorx.FrameWorx.DTO Listing` | (Not documented in source) |
  | listingAction | `RainWorx.FrameWorx.DTO ListingAction` | (Not documented in source) |
  | acceptedOffer | `RainWorx.FrameWorx.DTO Offer` | (Not documented in source) |
- **Returns:** Boolean
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | invoice | `RainWorx.FrameWorx.DTO Invoice` | (Not documented in source) |
...
- **Parameters:**
  ...
  | parameters | `RainWorx.FrameWorx.DTO PaymentParameters` | (Not documented in source) |
- **Returns:** PaymentProviderResponse
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | lineItem | `RainWorx.FrameWorx.DTO LineItem` | (Not documented in source) |
- **Returns:** LineItem
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | request | `RainWorx.FrameWorx.DTO UserInput` | (Not documented in source) |
- **Returns:** PaymentProviderResponse
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  | auctionEvent | `RainWorx.FrameWorx.DTO Event` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | lot | `RainWorx.FrameWorx.DTO Lot` | (Not documented in source) |
  | userInput | `RainWorx.FrameWorx.DTO UserInput` | (Not documented in source) |
- **Returns:** Boolean
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | listing | `RainWorx.FrameWorx.DTO Listing` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | query | `RainWorx.FrameWorx.DTO ListingPageQuery` | (Not documented in source) |
  | pageIndex | `System Int32` | (Not documented in source) |
  | pageSize | `System Int32` | (Not documented in source) |
...
- **Parameters:**
  ...
  |------|------|-------------|
  | userInput | `RainWorx.FrameWorx.DTO UserInput` | (Not documented in source) |
  | newOffer | `RainWorx.FrameWorx.DTO Offer` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  | reasonCode | `RainWorx.FrameWorx.DTO ReasonCode` | (Not documented in source) |
  | newPurchaseLineitem | `RainWorx.FrameWorx.DTO LineItem` | (Not documented in source) |
  | listing | `RainWorx.FrameWorx.DTO Listing` | (Not documented in source) |
- **Returns:** Boolean
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  | address | `RainWorx.FrameWorx.DTO Address` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | consignor | `RainWorx.FrameWorx.DTO Consignor` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
...
- **Parameters:**
  ...
  |------|------|-------------|
  | actingUserName | `System String` | (Not documented in source) |
  | user | `RainWorx.FrameWorx.DTO User` | (Not documented in source) |
- **Returns:** (Not documented in source)
- **Exceptions / Errors:**
  None documented
